...
let favoriteFoods = ["Ramen", "Sushi", "Pizza", "Burgers", "Tacos", "Fried Rice"];
...
let friendFavorites = [
    ...
    "Okonomiyaki", "Ceviche", "Brisket", "Bao Buns", "Poutine", "Clam Chowder", "Fajitas", 
    "Canelé", "Kimchi", "Tamales", "Omelette", "Biscuits", "Tempura", "Spring Rolls", "Crepes"
...
if (longFoodNames.length > shortFoodNames.length) {
    ...
    console.log("There are an equal number of long and short food names.");
}
